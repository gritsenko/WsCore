...
namespace System
{
    ...
    public class SimpleContainer
    {
        ...
        public void RegisterSingleton<TService>()
        {
            ...
            RegisterHandler(typeof(TService), typeof(TService).Name, container => singleton ?? (singleton = container.BuildInstance(typeof(TService))));
        }
        ...
        {
            object singleton = null;
            RegisterHandler(typeof(TInterface), typeof(TImpl).Name, container => singleton ?? (singleton = container.BuildInstance(typeof(TImpl))));
        }
        ...
        {
            object singleton = null;
            RegisterHandler(service, service.Name, container => singleton ?? (singleton = container.BuildInstance(implementation)));
        }
