...
export default class WorldMap {
    ...
    create(scene) {
        ...
        this.map = scene.make.tilemap({ width: 200, height: 200, tileWidth: WorldMap.cellSize, tileHeight: WorldMap.cellSize });
        ...
        scene.input.keyboard.on('keydown_E', function (event) {
            ...
            data.objecttype = 0;
            mp.create(scene, data, WorldMap.cellSize);
        });
    }
    ...
    updateMapObjects(objs) {
        ...
        for (var i = 0; i < o.length; i++) {
            this.createMapObject(o[i]);
        }
    }

    createMapObject(obj) {
        var mp = new MapObject();
        mp.create(this.currentScene, obj, WorldMap.cellSize);
    }
