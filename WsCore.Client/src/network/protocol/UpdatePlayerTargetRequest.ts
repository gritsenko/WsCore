...
export class UpdatePlayerTargetRequest {
    ...
    static serializeArrayCore(writer: MemoryPackWriter, value: (UpdatePlayerTargetRequest | null)[] | null): void {
    ...
    static deserializeArrayCore(reader: MemoryPackReader): (UpdatePlayerTargetRequest | null)[] | null {
