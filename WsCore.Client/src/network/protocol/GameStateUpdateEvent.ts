...
export class GameStateUpdateEvent {
    ...
    static serializeCore(writer: MemoryPackWriter, value: GameStateUpdateEvent | null): void {
        ...
        writer.writeArray(value.playerStateData, (writer, x) => PlayerStateData.serializeCore(writer, x));
    ...
    static serializeArrayCore(writer: MemoryPackWriter, value: (GameStateUpdateEvent | null)[] | null): void {
    ...
    static deserializeCore(reader: MemoryPackReader): GameStateUpdateEvent | null {
        ...
        if (count == 1) {
            ...
            value.playerStateData = reader.readArray(reader => PlayerStateData.deserializeCore(reader)); if (count == 1) return value;
