...
export class RoomUsersUpdateEvent {
    ...
    static serializeArrayCore(writer: MemoryPackWriter, value: (RoomUsersUpdateEvent | null)[] | null): void {
    ...
    static deserializeCore(reader: MemoryPackReader): RoomUsersUpdateEvent | null {
        ...
        if (count == 3) {
            ...
            value.users = reader.readArray(reader => RoomUserInfo.deserializeCore(reader)); if (count == 3) return value;
