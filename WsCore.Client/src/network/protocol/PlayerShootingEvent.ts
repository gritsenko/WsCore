...
export class PlayerShootingEvent {
    ...
    static serializeArrayCore(writer: MemoryPackWriter, value: (PlayerShootingEvent | null)[] | null): void {
    ...
    static deserializeCore(reader: MemoryPackReader): PlayerShootingEvent | null {
        ...
        if (count == 3) {
            ...
            value.weapon = reader.readInt32(); if (count == 2) return value;
            value.bulletIds = reader.readArray(reader => reader.readUint32()); if (count == 3) return value;
