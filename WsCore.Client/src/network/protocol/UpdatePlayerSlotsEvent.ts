...
export class UpdatePlayerSlotsEvent {
    ...
    static serializeArrayCore(writer: MemoryPackWriter, value: (UpdatePlayerSlotsEvent | null)[] | null): void {
    ...
    static deserializeCore(reader: MemoryPackReader): UpdatePlayerSlotsEvent | null {
        ...
        if (count == 4) {
            ...
            value.body = reader.readInt32(); if (count == 2) return value;
            value.gun = reader.readInt32(); if (count == 3) return value;
            value.armor = reader.readInt32(); if (count == 4) return value;
