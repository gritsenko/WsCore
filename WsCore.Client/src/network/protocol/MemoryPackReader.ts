...
export class MemoryPackReader {
  ...
  public tryReadObjectHeader(): [boolean, number] {
    ...
    return memberCount == nullObject ? [false, 0] : [true, memberCount];
  }
  ...
  public readMap<K, V>(
    keyReader: (reader: MemoryPackReader) => K,
    valueReader: (reader: MemoryPackReader) => V
  ): Map<K, V> | null {
    const [ok, length] = this.tryReadCollectionHeader();
    if (!ok) {
      return null;
  ...
  public readGuid(): string {
    ...
    return (
      ...
      b1.toString(16).padStart(2, '0') + // a
      '-' +
      b6.toString(16).padStart(2, '0') +
      b5.toString(16).padStart(2, '0') + // b
      '-' +
      b8.toString(16).padStart(2, '0') +
      b7.toString(16).padStart(2, '0') + // c
      '-' +
      b9.toString(16).padStart(2, '0') +
      b10.toString(16).padStart(2, '0') + // d e
      '-' +
      b11.toString(16).padStart(2, '0') +
      b12.toString(16).padStart(2, '0') + // f g
      b13.toString(16).padStart(2, '0') +
      b14.toString(16).padStart(2, '0') + // h i
      b15.toString(16).padStart(2, '0') +
      b16.toString(16).padStart(2, '0')
    ); // j k
  }
