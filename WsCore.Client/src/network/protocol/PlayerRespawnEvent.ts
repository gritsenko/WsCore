...
export class PlayerRespawnEvent {
    ...
    static serializeArrayCore(writer: MemoryPackWriter, value: (PlayerRespawnEvent | null)[] | null): void {
    ...
    static deserializeCore(reader: MemoryPackReader): PlayerRespawnEvent | null {
        ...
        if (count == 1) {
            ...
            value.playerStateData = PlayerStateData.deserializeCore(reader); if (count == 1) return value;
